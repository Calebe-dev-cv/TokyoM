  ...
  return (
    <>
      <div className="latest-uploads">
        <i className="fas fa-upload"></i> Ver Todos
      </div>
          ...
          <a href={`/info?id=${id}`} key={id}>
            <div className="listItem" id={id} onClick={() => sendData(index)}>
              ...
              <div className="listItemText">
                ...
                <p>Autor: {mangaData.mangaAuthor[index]}</p>
              </div>
            </div>
          </a>
        ))}
      ...
      <div className="pagination-wrapper">
        <button onClick={previousPage} aria-label="Previous Page">
          <i className="fa-solid fa-arrow-left"></i> Página Anterior
        </button>
        <button onClick={nextPage} aria-label="Next Page">
        Próxima Página<i className="fa-solid fa-arrow-right"></i>
        </button>
      </div>
    </>
  );
